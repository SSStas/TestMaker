...
class TestsTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var isGlobalLabel: UILabel!
    ...
    func setupWith(title: String, author: String, questionsNum: Int, games: String, likes: String, isGlobal: Bool) {
        titleLabel.text = title
        authorLabel.text = "От: \(author)"
        questionsLabel.text = "❓: \(questionsNum)"
        isGlobalLabel.text = isGlobal ? "Публичный" : "Приватный"
